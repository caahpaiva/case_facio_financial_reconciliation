...
![Distribuição por Status](outputs/figures/status_distribution.png)

## Breakdown por Produto
![Breakdown Produto](outputs/figures/breakdown_produto.png)

## Breakdown por Fundo
![Breakdown Fundo](outputs/figures/breakdown_fundo.png)

## Top 10 Divergências
![Top Divergências](outputs/figures/top_divergences.png)

## Série Temporal de VP
![Série Temporal](outputs/figures/analysis4_vp_timeseries.png)
